...
import { reset_password_create_password_async, reset_password_create_password_asyncv } from "../../../services/authService";
...
const ResetPasswordv = () => {
  ...
  const verifyHandle = () => {
    ...
    dispatch(reset_password_create_password_asyncv(obj));
    }
