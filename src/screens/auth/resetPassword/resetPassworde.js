...
import { reset_password_create_password_async, reset_password_create_password_asynce } from "../../../services/authService";
...
const ResetPassworde = () => {
  ...
  const verifyHandle = () => {
    ...
    dispatch(reset_password_create_password_asynce(obj));
    }
