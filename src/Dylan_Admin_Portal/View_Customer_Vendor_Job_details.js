...
const Customer_Vendor =()=>{
        ...
        useEffect(()=>{
            ...
            axios.get(`${baseURL}/get_vendor_customer_job_details/66146dd9ecaf4bcfff3b2f18`)
            .then((response)=>{


                console.log(response.data.data.Order_Id,"CUSTOMER_VENDOR_DETAILS")
