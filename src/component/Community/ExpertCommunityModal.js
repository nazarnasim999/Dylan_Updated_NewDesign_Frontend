...
import { create_customer_gig_async_service, create_customer_gig_async_service1, create_expert_gig_async_service1, get_customer_gig_async_service, get_customer_gig_async_service1, get_expert_gig_async_service1 } from "../../services/vendorService";
...
export default function ExpertGigModal() {
  ...
  const { create_customer_gig_status,
    create_customer_gig_data,
    create_customer_gig_error } = useSelector((state) => state.vendorAuth)
        ...
        >
            ...
            <Stack className="class-263">
                ...
                <Grid container alignItems={"center"} className="class-266">
                    ...
                    <Grid md={12} lg={12} sm={12} xs={12} mb={2} className="class-269">
                        <Input
                            name="title"
                    ...
                    <Grid md={12} lg={12} sm={12} xs={12} mb={2} className="class-272">
                        <Input
                            name="description"
                            onChange={(e) => setData({ ...data, gig_discription: e.target.value })}
                            style={{
                                padding: "10px 10px",
                                borderBottomLeftRadius: "7px",
                                borderTopLeftRadius: "7px",
                ...
                <Grid container className="class-275">
                    <Grid md={12} lg={12} sm={12} xs={12} mt={7} className="class-276">
                        <Stack mt={3} alignItems={'center'} className="class-277">
                            <Btn onClick={submitHandle} label={'Create Now'} style={{
                                backgroundColor: vendor_color,
                                border: 'none', outline: 'none', padding: "10px", borderRadius: '10px', color: 'white', cursor: "pointer", width: '30%'
                            }} className="class-278" />
                        </Stack>
                    </Grid>
                </Grid>
