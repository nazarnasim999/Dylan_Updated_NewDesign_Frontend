...
const Drawer_Side_Content = () => {
    ...
    const { get_matching_customer_status,
        ...
        get_matching_customer_error } = useSelector((state) => state.vendorAuth)
    ...
    useEffect(() => {
        ...
        if (get_matching_customer_data) {
            ...
            setCount(newCount - 1);
            console.log(get_matching_customer_data,"matchingdaatatataatpppppppppppppppppopo")
        }
    }, [get_matching_customer_data]); 
    ...
    return (
        <div style={{backgroundColor:'white', height:'850px' , overflowY:'scroll' , borderRadius:'15px'}}>
            {
                selectedIndexValue === "Customer" ? <Stack>
                    <Stack className='71boy'>
                        <Stack className='72boy' height={"260px"} sx={{ backgroundColor: 'white' }} style={{padding:'20px 10px 20px 10px'}} >

                            <Stack  className='73boy leaf'style={{backgroundColor:'#01BAF2' , padding:'30px 20px 30px 20px', borderRadius:'20px'}} >
                            ...
                            <Stack className='74boy' p={1}>
                                ...
                                <Stack className='75boy' flexDirection={'row'} alignItems={'center'} justifyContent={'space-between'} mt={0}>
                                    
                                           
                                            <Stack  className='76boy' sx={{
                                    fontSize: 70,
                                    fontWeight: 1000,
                                    color: 'white',
                                    '@media screen and (min-width:600px)': {
      ...
      >{get_vendor_profile_data?.length} </Stack>
                        ...
                        <Stack height={"35px"} sx={{ backgroundColor: "#D9D9D9" }}>
                            <Stack p={1}>
                                <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}>
                                    <Stack sx={{ fontSize: 18, color: "#333333", fontWeight: 'bold' }}>Showing All {get_vendor_profile_data?.length} Results</Stack>
                ...
                </Stack> : selectedIndexValue === "Vendor" ? < Stack >
                    <Stack >
                    ...
                    >
                        ...
                        <Stack height={"35px"} sx={{ backgroundColor: "#D9D9D9" }}>
                            <Stack p={1}>
                                <Stack flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'}>
                                    <Stack sx={{ fontSize: 11, color: "#333333", fontWeight: 'bold' }}>Showing All Results 
                                    {/* {get_jobs_length}  */}
                                    </Stack>
                                    <Stack flexDirection={'row'} alignItems={'center'} gap={0.2}>
                                        {/* <Stack>
