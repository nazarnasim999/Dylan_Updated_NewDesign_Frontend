...
const StepFiveChatWithVendor = ({job_id1}) => {
...
{console.log(job_id1,'ts')}
      ...
      <Stack sx={{ flexDirection: 'row', alignItems: 'start', justifyContent: 'space-between', marginTop: '10px' }} className='classname-467 customer_shedule2'>
              ...
              <Stack className='classname-471 customer_shedule7' style={{flexDirection:'column',alignItems:'center'}}>
...
<h1>Payment Successful</h1>
                      ...
                      style={{
                        ...
                        color: "white",
                        padding: '10px 85px', // Adjusted padding value
                        width: '290px',
                        height: '40px',
                        borderRadius: '5px', // Changed to string for consistency
                        background: '#01BAF2',
