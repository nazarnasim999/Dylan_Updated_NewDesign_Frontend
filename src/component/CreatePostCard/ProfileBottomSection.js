...
<div className='profile_section classname-555'>
    ...
    <Grid container className='by-bhai'>
        ...
        <Grid item md={12} lg={9} sm={12} xs={12} style={{ paddingRight: '5px' }} className="classname-556">

        <div className='classname-557'>


                <div style={{ display: 'flex', justifyContent: 'end', gap: '10px' }} className="classname-558">
                    <Helpful />
          ...
          <div className="classname-559">  <div style={{ fontSize: '40px', fontWeight: 'bold', color: main_color }} className="classname-560">SHEDULED PROJECTS</div></div>
            ...
            <Stack className="classname-562">
                ...
                {/* mywork */}
                <Stack sx={{ color: '#000000', fontSize: { md: 16, lg: 16, sm: 10, xs: 8 } }} className="classname-537"></Stack>
                <Stack sx={{ color: '#000000', fontSize: { md: 16, lg: 16, sm: 10, xs: 8 } }} className="classname-538"></Stack>

                <Stack flexDirection={'row'} alignItems={'center'} gap={0.5} mt={0.9} className="classname-539">
                ...
                <Stack mt={1} flexDirection={"row"} justifyContent={'space-between'} alignItems={'center'} className="classname-564">
                    <Stack sx={{ color: '#000000', fontSize: { md: 40, lg: 40, sm: 30, xs: 17 }, fontWeight: 1000, mt: 1 }} className="classname-565">Profile</Stack>
        ...
        <Grid item  md={12} lg={3} sm={12} xs={12} className="classname-569" style={{marginTop:'37px'}}>
            <Stack className="classname-545">

                <Stack style={{ background: 'transparent' }} className='side_scroll_handle_for_scheduled classname-546' mt={2}  >
