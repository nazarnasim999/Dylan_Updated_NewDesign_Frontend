...
const SelectVendorStep3 = ({job_id1}) => {
...
<ViewVendorProfile vendorID={e.vendorId}/>
        ...
        <div class="sh-list-2">
          ...
          </svg><p>Budget: {e.vendorBudget}</p></span>
...
<div class="sh-box-2 select-button">
    <button onClick={()=>{AcceptHanlde(e.scheduleId)}}>Select</button>
...
export default SelectVendorStep3 
