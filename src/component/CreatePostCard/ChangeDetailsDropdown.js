...
const ChangeSetting = ({ userInfo }) => {
  ...
  const [showViewPaymentOptionsForm, setshowViewPaymentOptionsForm] = useState(false);
  ...
  const handlePaymentOptionsSubmit = async (e) => {
    ...
    console.log(bankname,accountname,accountnumber,iban,"Bank Details",profile.customer_id)
    ...
    <>
      <Dropdown className=''>
        <Dropdown.Toggle variant="" id="">
          <img src={settingbutton} alt="" className='setting-img' style={{width:'40%'}}/>
        </Dropdown.Toggle>
        <Dropdown.Menu>
          
          <Dropdown.Item onClick={handleProfileFormClick}>View Information</Dropdown.Item>
          <Dropdown.Item onClick={handleViewProfileInfoOptionsClick}>Change Information </Dropdown.Item>
          <Dropdown.Item onClick={handlePaymentOptionsClick}>Payment Options</Dropdown.Item>
          <Dropdown.Item onClick={handleViewPaymentOptionsClick}>View Payment </Dropdown.Item>

        </Dropdown.Menu>
      </Dropdown>
      {showProfileForm && (
        <div className="modal fade show" id="profileModal" tabIndex="-1" role="dialog" aria-labelledby="profileModalLabel" aria-hidden="true" style={{ display: 'block' }}>
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="profileModalLabel">Profile Details</h5>
                <button type="button" className="close" onClick={() => setShowProfileForm(false)} aria-label="Close">
      ...
      {showPaymentOptionsForm && (
        <div className="modal fade show" id="paymentOptionsModal" tabIndex="-1" role="dialog" aria-labelledby="paymentOptionsModalLabel" aria-hidden="true" style={{ display: 'block' }}>
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="paymentOptionsModalLabel"> Add Payment </h5>
                <button type="button" className="close" onClick={() => setShowPaymentOptionsForm(false)} aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div className="modal-body">
...
<div className="modal-dialog" role="document">
  <div className="modal-content">
    <div className="modal-header">
      <h5 className="modal-title" id="paymentOptionsModalLabel">View Payment Details </h5>
      <button type="button" className="close" onClick={() => setshowViewPaymentOptionsForm(false)} aria-label="Close">
        <span aria-hidden="true">&times;</span>
      </button>
    </div>
    <div className="modal-body">
...
{showviewProfileForm && (
        ...
        <div className="modal-dialog" role="document">
          <div className="modal-content">
            <div className="modal-header">
              <h5 className="modal-title" id="paymentOptionsModalLabel">Change Profile Info</h5>
              <button type="button" className="close" onClick={() => setshowviewProfileForm(false)} aria-label="Close">
                <span aria-hidden="true">&times;</span>
              </button>
            </div>
            <div className="modal-body">
              <form onSubmit={handleUpdateProfileInfo} className='formkk'>
                <div className="form-groupkk">
                  ...
                  <input type="text" className="form-control" id="accountHolderName" name="accountHolderName" value={Name} onChange={(e)=>setName(e.target.value)} />
                </div>
                <div className="form-groupkk">
                  <label htmlFor="accountNumber">Email</label>
                  <input type="text" className="form-control" id="accountNumber" name="accountNumber" value={email} onChange={(e)=>setemail(e.target.value)} />
                </div>
                <div className="form-groupkk">
                  <label htmlFor="iban">Phone</label>
                  <input type="text" className="form-control" id="iban" name="iban"  value={phoneno} onChange={(e)=>setphoneno(e.target.value)}/>
                </div>
                <div className="form-groupkk">
                  <label htmlFor="bankName">Address</label>
                  <input type="text" className="form-control" id="bankName" name="bankName" value={Home_Address} onChange={(e)=>setHome_Address(e.target.value)} />
                </div>
                {/* <div className="form-groupkk">
                  <label htmlFor="bankAddress">Bank Address</label>
                  <input type="text" className="form-control" id="bankAddress" name="bankAddress" />
