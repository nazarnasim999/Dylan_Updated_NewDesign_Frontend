...
const VendorProfileCard = () => {
  ...
  const { vendor_profile_status,
    vendor_profile_data,
    vendor_login_data,
    vendor_data,
    vendor_profile_error } = useSelector((state) => state.vendorAuth)
  ...
  return (
    <>
      <Container maxWidth="xl" style={{ paddingRight: '0px' }} className="classname-580">
    <Stack sx={{ position: 'relative' }} className="classname-581">
        ...
        <Stack sx={{
            ...
            left: 20,
          }} style={{width:"100%"}} className="classname-434">
            <Stack className="nazar bhai" flexDirection={'column'} alignItems={'end'} style={{width:'100%'}} >
                <Stack className="classname-435"  style={{width:'24.5%', backgroundColor:'white', paddingTop:'25px' , paddingLeft:'10px', paddingBottom:'0px',borderRadius:'15px'}}  >
                    <div style={{display:'flex' , flexDirection:'row', alignItems:'center'}} className="classname-589">
                        <Avatar
                            alt="Remy Sharp"
                            sx={{
                    ...
                    <Stack flexDirection={'row'} justifyContent={'end'} className="classname-592">
                        <ChangeSetting userInfo={userInfo} className="classname-593" />
                    </Stack>
                    <input
                        type="file"
                        id="fileInput"
...
<label htmlFor="fileInput"  style={{ position: 'absolute', left: '90px', bottom: '40px' }}>
        ...
        <Stack sx={{}} flexDirection={'row'} justifyContent={'space-between'} alignItems={'center'} className="classname-595">
            <Stack className="classname-596"></Stack>
            <Stack flexDirection={'row'} alignItems={'center'}>
                <Stack sx={{ fontSize: { lg: 30, md: 30, sm: 17, xs: 17 }, fontWeight: 800, mt: { lg: 4, md: 4, sm: 2, xs: 2 } }} className="classname-597">
                    {/* Over-all Rating: */}
                </Stack>
                <Stack sx={{ fontSize: { lg: 50, md: 50, sm: 20, xs: 20 }, fontWeight: 1000, mt: 3 }} className="classname-598">
                    {/* 4.5 */}
                    <br/>
                </Stack>
            </Stack>
